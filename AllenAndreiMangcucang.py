...
while True:
    ...
    if (left_paddle_x < ball_x < left_paddle_x + paddle_width and left_paddle_y < ball_y < left_paddle_y + paddle_height) or (right_paddle_x < ball_x < right_paddle_x + paddle_width and right_paddle_y < ball_y < right_paddle_y + paddle_height):
    ...
    if ball_x <= 0:
        score_right += 1
        ball_x, ball_y, ball_speed_x, ball_speed_y = rese_ball()
